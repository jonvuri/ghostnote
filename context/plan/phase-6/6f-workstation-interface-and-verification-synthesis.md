...
kind: plan
state: planned
status: Next. Select interfaces and prepare the Phase 7 dogfood surface.
updated: 2026-09-13
parent: README.md
...
- E106 through E108 reject the tested perceptual providers under the old
  factual gate.
- E113 completes the listener-agreement evaluation and selects no perceptual
  provider. Loudness predicts the derived public arousal reference, but the
  reference provenance, loudness control, audio license chain, and silence
  behavior prevent selection.
