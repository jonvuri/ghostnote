...
test('description v11 names one complete and explicit cohort', () => {
  assert.equal(TOOL_DESCRIPTION_VERSION, 'ghostnote-description-v11');
...
test('description v11 matches its public artifact', () => {
