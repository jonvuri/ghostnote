...
before the fresh agent trial. E132 rejects the universal flush fence and leaves
the reader unchanged. Run the
[hybrid observer acquisition](7b-follow-up-hybrid-observer-acquisition.md)
experiment next. After E133, start the fresh agent's server with
