...
5. [5 — live proving program](5-proving.md) — active; the focused re-cut was
   ...
   - [5d — concurrent editing](5d-concurrent-editing.md) — attempted twice; E28
     stopped the rerun before the human window
   ...
   - [5d repair — cursor confirmation](5d-repair-cursor-confirmation.md) — retry
     lagging confirmation and preserve early cleanup fingerprints (E28)
