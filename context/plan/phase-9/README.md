---
title: Phase 9 — Breadth and release
kind: plan
state: planned
...
# Phase 9 — Breadth and release

> **Purpose.** Everything that is genuinely useful but does not gate anything else.
> Unlike Phases 0–8 this is **not a sequenced phase** — it is a backlog of
...
[9a — `bwmod` publication review and extraction](9a-bwmod-publication-review.md)
is the first selected backlog item after the Phase 8 dogfood gate closes. The
...
the project as a whole is the Phase 8 dogfood gate, applied continuously: **does it
get used?**
